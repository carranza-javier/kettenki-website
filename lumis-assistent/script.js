...
// ==========================================
// FIX: Teclado Android en kiosco (FreeKiosk)
// ==========================================
function setupKeyboardFix() {
    ...
    function onViewportChange() {
        ...
        // Altura visible real (excluye el teclado)
        const visibleHeight = Math.round(vv.height + vv.offsetTop);

        // Aplicar al chat-state (flexbox column)
        const chatState = document.getElementById('chat-state');
        if (chatState && !chatState.classList.contains('hidden')) {
            chatState.style.height = visibleHeight + 'px';
        }

        // Aplicar al empty-state también (login / pantalla inicial)
        const emptyState = document.getElementById('empty-state');
        if (emptyState && !emptyState.classList.contains('hidden')) {
            emptyState.style.height = visibleHeight + 'px';
        }

        // Scroll al final de los mensajes tras ajuste
