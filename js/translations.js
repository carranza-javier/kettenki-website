const translations = {
  de: {
    ...
    rd_p5: 'Und an dieser Stelle habe ich etwas entdeckt, das meiner Meinung nach mehr Entwicklerinnen und Entwickler kennen sollten: GitHub Security Advisories und Private Vulnerability Reporting.',
    ...
    rd_cwe_1: 'Während ich das Problem untersucht und dokumentiert habe, bin ich nebenbei auch tiefer in CWE eingestiegen, Common Weakness Enumeration. CWE wird von MITRE gepflegt und liefert eine gemeinsame Klassifikation, um verschiedene Arten von Softwareschwächen zu beschreiben. Zum Beispiel:',
    ...
    rd_cwe_2: 'Letzteres fand ich besonders interessant, wegen seines Bezugs zu dem Problem, das ich gefunden hatte. CWE-269 beschreibt ganz allgemein Situationen, in denen die Privilegien eines Nutzers nicht korrekt verwaltet werden.',
  ...
  en: {
    ...
    rd_p5: 'And this is where I discovered something I think more developers should know about: GitHub Security Advisories and Private Vulnerability Reporting.',
    ...
    rd_cwe_1: 'While I was investigating and documenting the problem, I also ended up digging into CWE, Common Weakness Enumeration. CWE, maintained by MITRE, provides a common classification for describing different types of software weaknesses. For example:',
    rd_cwe_item_1: 'CWE-22, Path Traversal',
    rd_cwe_item_2: 'CWE-79, Cross-Site Scripting',
    rd_cwe_item_3: 'CWE-89, SQL Injection',
    rd_cwe_item_4: 'CWE-862, Missing Authorization',
    rd_cwe_item_5: 'CWE-269, Improper Privilege Management',
    rd_cwe_2: 'That last one felt especially interesting to me because of its relation to the problem I had found. CWE-269 covers, broadly speaking, situations where a user\'s privileges are not managed correctly.',
