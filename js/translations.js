const translations = {
  de: {
    ...
    rd_p1: 'Ich habe eine Open-Source-Anwendung ausprobiert, als ich auf etwas gestoßen bin, mit dem ich nicht gerechnet hatte.',
    rd_p2: 'Am Anfang war es einfach dieses Gefühl: "Moment mal... sollte das gerade wirklich passieren?"',
    rd_p3: 'Ich habe weiter nachgeforscht und angefangen zu vermuten, dass es sich um ein Sicherheitsproblem handeln könnte.',
    rd_p4: 'Und da kam ein Gefühl auf, das sich deutlich von dem unterscheidet, das man hat, wenn man irgendeinen beliebigen Bug findet.',
    rd_p5: 'Wow.',
    rd_p6: 'Auf einmal war ich motiviert. Ich wollte verstehen, was da passiert, es überprüfen und, falls es wirklich eine Schwachstelle war, dabei helfen, sie zu beheben.',
    rd_p7: 'Aber zuerst stand das Wichtigste an: es reproduzieren.',
    rd_p8: 'Ich wollte keinen Verdacht und kein False Positive melden. Ich musste sicher sein, dass das Verhalten echt ist, verstehen, unter welchen Bedingungen es auftritt, und prüfen, welche Auswirkung es haben kann.',
    rd_p9: 'Nachdem ich es reproduziert und besser verstanden hatte, was da vor sich geht, kam die nächste Frage: Wie meldet man eigentlich verantwortungsvoll eine Schwachstelle in einem Open-Source-Projekt?',
    rd_p10: 'Und an dieser Stelle habe ich etwas entdeckt, das meiner Meinung nach mehr Entwicklerinnen und Entwickler kennen sollten: GitHub Security Advisories und Private Vulnerability Reporting.',
    rd_h_issue: 'Nicht jeder Bug sollte zu einem Issue werden',
    rd_issue_1: 'Wenn du in einem Open-Source-Projekt einen ganz normalen Bug findest, ist es vermutlich üblich, ein Issue zu eröffnen oder einen Pull Request vorzubereiten.',
    rd_issue_2: 'Eine Schwachstelle ist aber etwas anderes.',
    rd_issue_3: 'Wenn wir die Details eines Sicherheitsproblems sofort veröffentlichen, sorgen wir womöglich dafür, dass die Information jeden erreicht, bevor die Maintainer Zeit hatten, es zu beheben.',
    rd_issue_4: 'Und das kann besonders problematisch sein, wenn das Projekt Nutzer hat, die eine verwundbare Version einsetzen.',
    rd_issue_5: 'Deshalb gibt es das Konzept Responsible Disclosure: das Problem so zu kommunizieren, dass das Projekt eine faire Gelegenheit bekommt, es zu untersuchen und zu beheben, bevor die Details öffentlich werden.',
    rd_h_advisory: 'GitHub Security Advisory',
    rd_adv_1: 'GitHub hat für genau solche Situationen ein eigenes Werkzeug: Private Vulnerability Reporting.',
    rd_adv_2: 'Die Idee finde ich ziemlich gut. Statt ein öffentliches Issue zu eröffnen, in dem es alle sehen können und das Problem offenliegt, kannst du einen privaten Kanal nutzen: Der Maintainer bekommt den Report, untersucht ihn, bereitet einen Fix vor und testet ihn, veröffentlicht ihn, und erst danach folgt die koordinierte Offenlegung.',
    ...
    rd_adv_3: 'Während dieses gesamten Prozesses bleiben die Details der Schwachstelle privat.',
    rd_adv_4: 'Und genau das finde ich an diesem Mechanismus interessant. Du versuchst nicht, unbegrenzt zu verstecken, dass es ein Problem gibt. Du gibst dem Projekt etwas sehr Wichtiges: Zeit.',
    rd_adv_5: 'Zeit, um zu verstehen, was passiert. Zeit, um eine Lösung vorzubereiten. Zeit, um sie zu testen. Und Zeit, um eine korrigierte Version zu veröffentlichen, bevor öffentlich erklärt wird, wie sich die verwundbare Version ausnutzen lässt.',
    rd_h_cwe: 'Etwas, das ich unterwegs entdeckt habe: CWE',
    rd_cwe_1: 'Während ich das Problem untersucht und dokumentiert habe, bin ich nebenbei auch tiefer in CWE eingestiegen, Common Weakness Enumeration.',
    rd_cwe_2: 'CWE wird von MITRE gepflegt und liefert eine gemeinsame Klassifikation, um verschiedene Arten von Softwareschwächen zu beschreiben. Zum Beispiel:',
    ...
    rd_cwe_3: 'Letzteres fand ich besonders interessant, wegen seines Bezugs zu dem Problem, das ich gefunden hatte.',
    rd_cwe_4: 'CWE-269 beschreibt ganz allgemein Situationen, in denen die Privilegien eines Nutzers nicht korrekt verwaltet werden.',
    ...
    rd_cwe_5: 'Und ich glaube, es gibt eine interessante Frage, die wir uns beim Thema Autorisierung stellen können: nicht nur "darf dieser Nutzer das tun?", sondern auch "was passiert, wenn er es nicht mehr darf?"',
    rd_cwe_6: 'Rechte zu vergeben ist eine Operation. Sie korrekt wieder zu entziehen ebenfalls.',
    ...
    rd_what_2: 'Der erste Teil ist für mich der wichtigste: erst reproduzieren.',
    rd_what_3: 'Etwas zu finden, das nach einer Schwachstelle aussieht, kann aufregend sein, aber es ist auch leicht, zu schnell Schlüsse zu ziehen.',
    rd_what_4: 'Eine saubere Reproduktion verändert den Report komplett. Du sagst dann nicht mehr "ich glaube, hier könnte ein Problem sein". Du kannst sagen "ich habe dieses Verhalten unter diesen Bedingungen reproduziert, und das ist die Auswirkung, die ich beobachtet habe".',
    rd_what_5: 'Das erleichtert den Maintainern die Arbeit enorm.',
    rd_h_exp: 'Eine Erfahrung, die mir besonders gefallen hat',
    rd_exp_1: 'Am meisten überrascht hat mich an alledem, dass das Entdecken einer Schwachstelle etwas ausgelöst hat, womit ich nicht gerechnet hatte: Lust, beizutragen.',
    rd_exp_2: 'Nicht nur das Problem zu finden und zu sagen "schaut mal, was ich gefunden habe", sondern dabei zu helfen, es zu lösen.',
    rd_exp_3: 'Und ich glaube, das ist einer der schönen Teile von Open Source. Du kannst gerade eine Anwendung benutzen, aus Neugier Code lesen oder versuchen zu verstehen, wie ein bestimmter Teil des Systems funktioniert, und plötzlich stößt du auf etwas, das es wert ist, repariert zu werden.',
    rd_exp_4: 'In diesem Moment musst du kein Security Researcher sein. Du brauchst Neugier, du musst überprüfen, was du da siehst, und, falls es wirklich ein Problem ist, es verantwortungsvoll melden.',
    rd_exp_5: 'GitHub stellt einen Teil der dafür nötigen Infrastruktur bereits bereit.',
    rd_exp_6: 'Vielleicht lohnt es sich beim nächsten Mal, wenn du auf so etwas stößt, statt direkt ein öffentliches Issue zu eröffnen, erst einmal zu suchen: SECURITY.md, Security Policy, Private Vulnerability Reporting, Security Advisory.',
    rd_exp_7: 'Vielleicht findest du einen viel besseren Weg, es zu melden. Und nebenbei kannst du dabei richtig viel lernen.',
  ...
  en: {
    ...
    rd_p1: 'I was trying out an Open Source application when I found something I did not expect.',
    rd_p2: 'At first it was simply that feeling of: "Wait... should this be happening?"',
    rd_p3: 'I kept digging and started to suspect it could be a security issue.',
    rd_p4: 'And that brought up a feeling quite different from the one you get when you find just any bug.',
    rd_p5: 'Wow.',
    rd_p6: 'All of a sudden I felt motivated. I wanted to understand what was going on, verify it and, if it really was a vulnerability, help get it fixed.',
    rd_p7: 'But before anything else came the most important part: reproducing it.',
    rd_p8: 'I did not want to report a suspicion or a false positive. I needed to be sure the behaviour was real, to understand under which conditions it happened, and to check what its impact could be.',
    rd_p9: 'After reproducing it and getting a better picture of what was going on, the next question arrived: how do you responsibly report a vulnerability in an Open Source project?',
    rd_p10: 'And this is where I discovered something I think more developers should know about: GitHub Security Advisories and Private Vulnerability Reporting.',
    rd_h_issue: 'Not every bug should become an Issue',
    rd_issue_1: 'When you find a normal bug in an Open Source project, the usual thing is probably to open an Issue or prepare a Pull Request.',
    rd_issue_2: 'But a vulnerability is different.',
    rd_issue_3: 'If we immediately publish the details of a security problem, we may be handing that information to anyone before the maintainers have had time to fix it.',
    rd_issue_4: 'And that can be especially problematic if the project has users running a vulnerable version.',
    rd_issue_5: 'That is why the concept of responsible disclosure exists: communicating the problem in a way that gives the project a reasonable opportunity to investigate and fix it before the details become public.',
    rd_h_advisory: 'GitHub Security Advisory',
    rd_adv_1: 'GitHub has a specific tool for this kind of situation: Private Vulnerability Reporting.',
    rd_adv_2: 'I think the idea is rather good. Instead of opening a public Issue, where everyone can see it and the problem is exposed, you can use a private channel: the maintainer receives the report, investigates it, prepares and tests a fix, ships it, and only then comes the coordinated disclosure.',
    ...
    rd_adv_3: 'Throughout that whole process, the details of the vulnerability stay private.',
    rd_adv_4: 'And that is precisely what I find interesting about this mechanism. You are not trying to hide the existence of a problem indefinitely. You are giving the project something very important: time.',
    rd_adv_5: 'Time to understand what is happening. Time to prepare a fix. Time to test it. And time to release a corrected version before explaining publicly how to exploit the vulnerable one.',
    rd_h_cwe: 'One thing I discovered along the way: CWE',
    rd_cwe_1: 'While I was investigating and documenting the problem, I also ended up digging into CWE, Common Weakness Enumeration.',
    rd_cwe_2: 'CWE, maintained by MITRE, provides a common classification for describing different types of software weaknesses. For example:',
    rd_cwe_item_1: 'CWE-22, Path Traversal',
    rd_cwe_item_2: 'CWE-79, Cross-Site Scripting',
    rd_cwe_item_3: 'CWE-89, SQL Injection',
    rd_cwe_item_4: 'CWE-862, Missing Authorization',
    rd_cwe_item_5: 'CWE-269, Improper Privilege Management',
    rd_cwe_3: 'That last one felt especially interesting to me because of its relation to the problem I had found.',
    rd_cwe_4: 'CWE-269 covers, broadly speaking, situations where a user\'s privileges are not managed correctly.',
    ...
    rd_cwe_5: 'And I think there is an interesting question we can ask ourselves when working with authorization: not only "can this user do this?", but also "what happens when they can no longer do it?"',
    rd_cwe_6: 'Granting permissions is an operation. Revoking them properly is one too.',
    ...
    rd_what_2: 'The first part is, for me, the most important one: reproduce it first.',
    rd_what_3: 'Finding something that looks like a vulnerability can be exciting, but it is also easy to jump to conclusions too quickly.',
    rd_what_4: 'A clear reproduction changes the report completely. You are no longer saying "I think there might be a problem here". You can say "I reproduced this behaviour under these conditions and this is the impact I observed".',
    rd_what_5: 'That makes the maintainer\'s job so much easier.',
    rd_h_exp: 'An experience I especially enjoyed',
    rd_exp_1: 'What surprised me most about all this is that discovering a vulnerability produced something I did not expect: the urge to contribute.',
    rd_exp_2: 'Not only to find the problem and say "look what I found", but to help fix it.',
    rd_exp_3: 'And I think this is one of the beautiful parts of Open Source. You might be using an application, reading code out of curiosity or trying to understand how a certain part of the system works and, suddenly, you find something worth fixing.',
    rd_exp_4: 'In that moment you do not need to be a security researcher. You need curiosity, you need to verify what you are seeing and, if it really is a problem, report it responsibly.',
    rd_exp_5: 'GitHub already provides part of the infrastructure needed to do that.',
    rd_exp_6: 'Maybe next time you find something like this, instead of opening a public Issue straight away, it is worth looking first for: SECURITY.md, Security Policy, Private Vulnerability Reporting, Security Advisory.',
    rd_exp_7: 'You might find a much better path to report it. And on top of that, you can end up learning a lot along the way.',
