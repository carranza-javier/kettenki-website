const translations = {
  de: {
    ...
    examples_subtitle: 'Keine Bildschirmfotos, sondern fertige Seiten, durch die du dich klicken kannst.',
    examples_intro: 'Für jede Art von Betrieb bauen wir eine vollständige Beispielseite — mit erfundenem Namen, erfundenen Preisen und echter Arbeit dahinter. So siehst du, wie deine Seite aussehen könnte, bevor irgendetwas vereinbart ist.',
    ...
    example_keramik_text: 'Katalog, Produktseiten, Warenkorb und Kasse für ein Keramikatelier. Sechzehn Kacheln im Raster, und eine davon ist kein Foto, sondern ein Film — man merkt es erst, wenn er sich bewegt.',
  ...
  en: {
    ...
    examples_subtitle: 'Not screenshots — finished sites you can click your way through.',
    examples_intro: 'For each kind of business we build a complete example site, with an invented name, invented prices and real work behind it. That way you can see what your site could look like before anything is agreed.',
    ...
    example_keramik_text: 'Catalogue, product pages, cart and checkout for a ceramics studio. Sixteen tiles in the grid, and one of them is not a photo but a film — you only notice once it moves.',
