const translations = {
  de: {
    ...
    services_websites_examples: 'Fertige Beispielseiten ansehen',
    examples_title: 'Beispiele',
    examples_subtitle: 'Fertige Seiten, durch die du dich wirklich klicken kannst.',
    examples_more: 'Weitere Beispiele kommen dazu, sobald sie fertig sind.',
    examples_cta_text: 'Soll deine Seite hier als Nächstes stehen?',
    example_open: 'Demo öffnen ↗',
    example_keramik_tag: 'Onlineshop',
    example_keramik_title: 'Atelier Lehm verkauft Keramik',
    example_keramik_text: 'Leg ein Stück in den Warenkorb und geh bis zur Kasse. Es funktioniert alles, nur abgebucht wird nichts.',
    example_schule_tag: 'Sprachschule',
    example_schule_title: 'Sprachwerk Bern',
    example_schule_text: 'Hinter der Seite liegen zwei Dinge, die sonst Geld kosten: ein Buchungskalender und ein Lernbereich mit Material, Aufgaben und Terminen.',
    example_galerie_tag: 'Galerie und Portfolio',
    example_galerie_title: 'Ausstellungsraum Halle Neun',
    example_galerie_text: 'So sieht eine Seite aus, die ganz der Arbeit gehört: grosse Bilder auf fast schwarzem Grund, eine Seite pro Werk, eine Aufnahme, die sich bewegt.',
    ...
    railtrack_walkthrough_login: 'Die Anwendung nutzt HashiCorp Vault für die Verwaltung von Secrets. Bevor das Backend gestartet wird, muss deshalb ein Vault-Server laufen. Ist Vault bereit, startet zuerst das Backend und danach das Frontend. Es gibt keine vorangelegten Benutzer: Zuerst muss über die API ein Benutzer angelegt werden, mit dessen Zugangsdaten man sich anschliessend im Login-Bildschirm anmeldet.',
    ...
    laguitarrita_did_3: 'Habe das DNS in Cloudflare im Modus "DNS only" konfiguriert, damit es konfliktfrei mit dem HTTPS-Zertifikat von GitHub Pages zusammenspielt, statt des standardmässigen Proxy-Modus.',
    ...
    cleancode_list_3: 'Mach nicht jede Refaktorierung zu einem grossen Projekt: Hör nicht auf, dem Kunden Mehrwert zu liefern, nur um eine komplette Bereinigung des Systems anzugehen. Der Code kann sich organisch nebenbei verbessern, eingebettet in den täglichen Arbeitsfluss.',
    ...
    cleancode_p5: 'Übernimmt ausserdem eine einzelne Person diese Aufgabe, wird sie unbemerkt zur "verantwortlichen Person" für diesen Teil des Systems. Ihr Name taucht bei allen wichtigen Änderungen auf, und wenn etwas passiert, richten sich die Blicke leicht auf sie.',
    ...
    rd_alt_cwe269: 'Illustration zu CWE-269, unsachgemässe Verwaltung von Privilegien: Ein Nutzer ohne ausreichende Berechtigungen schafft es, eine Aktion auszuführen, die für ihn gesperrt sein sollte.',
    ...
    rd_exp_2: 'Und ich glaube, das ist einer der schönen Teile von Open Source. Du kannst gerade eine Anwendung benutzen, aus Neugier Code lesen oder versuchen zu verstehen, wie ein bestimmter Teil des Systems funktioniert, und plötzlich stösst du auf etwas, das es wert ist, repariert zu werden.',
    ...
    rd_exp_4: 'Vielleicht lohnt es sich beim nächsten Mal, wenn du auf so etwas stösst, statt direkt ein öffentliches Issue zu eröffnen, erst einmal zu suchen: SECURITY.md, Security Policy, Private Vulnerability Reporting, Security Advisory. Vielleicht findest du einen viel besseren Weg, es zu melden. Und nebenbei kannst du dabei richtig viel lernen.',
  ...
  en: {
    ...
    services_websites_examples: 'See finished example sites',
    examples_title: 'Examples',
    examples_subtitle: 'Finished sites you can actually click through.',
    examples_more: 'More examples will follow as they are finished.',
    examples_cta_text: 'Should your site be the next one here?',
    example_open: 'Open the demo ↗',
    example_keramik_tag: 'Online shop',
    example_keramik_title: 'Atelier Lehm sells ceramics',
    example_keramik_text: 'Put a piece in the basket and go all the way to checkout. Everything works, only nothing is ever charged.',
    example_schule_tag: 'Language school',
    example_schule_title: 'Sprachwerk Bern',
    example_schule_text: 'Behind the page sit two things that usually cost money: a booking calendar and a student area with material, exercises and dates.',
    example_galerie_tag: 'Gallery and portfolio',
    example_galerie_title: 'Halle Neun exhibition space',
    example_galerie_text: 'This is what a page looks like when it belongs entirely to the work: large images on near black, a page per piece, one shot that moves.',
