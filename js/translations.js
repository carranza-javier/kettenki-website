const translations = {
  de: {
    ...
    canary_how_3: 'Als das neue System bereits eine Weile lang echten Traffic problemlos verarbeitet hatte, gaben wir dem Partner einen neuen Endpunkt, der direkt auf die Cloud-Plattform zeigte. Und als alle Partner migriert waren, schalteten wir das alte System kontrolliert ab, nachdem wir geprüft hatten, dass kein Restfluss mehr davon abhing.',
  ...
  en: {
    ...
    canary_how_3: 'Once the new system had been processing real traffic without issues for a while, we gave the partner a new endpoint that pointed directly to the cloud platform. And once all partners were migrated, we shut down the old system in a controlled way, verifying that no residual flow still depended on it.',
