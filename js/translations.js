const translations = {
  de: {
    ...
    bambera_benefit2: 'Funktioniert in mehreren Sprachen (Deutsch, Französisch, Italienisch, Englisch, Spanisch)',
    ...
    bambera_case1_question: 'Welche Lebensmittel enthalten kein Gluten?',
  ...
  en: {
    ...
    bambera_for_whom: 'Hospitality, childcare, industrial or commercial sectors with complex operational manuals.',
    bambera_benefit1: 'Instant access to operational knowledge',
    bambera_benefit2: 'Works in multiple languages (German, French, Italian, English, Spanish)',
    bambera_benefit3: 'Reduced staff training time',
    bambera_benefit4: 'Mobile-optimized interface',
    bambera_case1_title: 'Hospitality',
    bambera_case1_question: 'Which foods are gluten-free?',
