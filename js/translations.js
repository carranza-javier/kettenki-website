const translations = {
  de: {
    ...
    example_keramik_title: 'Atelier Lehm, Keramikstudio',
    example_keramik_text: 'Ein kompletter Onlineshop für ein Keramikatelier, mit Katalog, Produktseiten, Warenkorb und Kasse.',
    example_schule_tag: 'Sprachschule',
    example_schule_title: 'Sprachwerk Bern, Deutschkurse',
    example_schule_text: 'Eine Website für eine Sprachschule, mit Terminbuchung, Lernbereich für Teilnehmende und Kursübersicht.',
    example_galerie_tag: 'Galerie und Portfolio',
    example_galerie_title: 'Halle Neun, Atelier und Galerie',
    example_galerie_text: 'Ein Portfolio für Kunst und Fotografie, mit grossem Werkraster, Seiten zu jeder Arbeit und einer bewegten Aufnahme mittendrin.',
  ...
  en: {
    ...
    example_keramik_title: 'Atelier Lehm, ceramics studio',
    example_keramik_text: 'A complete ecommerce site for a ceramics studio, with catalogue, product pages, cart and checkout.',
    example_schule_tag: 'Language school',
    example_schule_title: 'Sprachwerk Bern, German courses',
    example_schule_text: 'A website for a language school, with lesson booking, a student area and a course overview.',
    example_galerie_tag: 'Gallery and portfolio',
    example_galerie_title: 'Halle Neun, studio and gallery',
    example_galerie_text: 'A portfolio for art and photography, with a large work grid, a page for every piece and one moving shot in the middle of it.',
